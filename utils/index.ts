import { CarCardInterface, FilterInterface } from "@/types";

export async function fetchCars(filters: FilterInterface) {
    const {manufacturer, model, year, fuel, limit} = filters

    const headers = {
		'X-RapidAPI-Key': 'db99081036msh45e7f9cb7e57670p11e36fjsn91ca68a21efe',
...
export const calculateCarRent = (city_mpg: number, year: number) => {
  ...
  export const generalCarImageUrl = (car: CarCardInterface, angle?: string) => {
